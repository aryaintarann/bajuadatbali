        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form class="row g-3" method="POST" action="{{ route('setting.update', $setting->id_setting) }}" enctype="multipart/form-data">
                    ...
                    <div class="col-md-6 mb-3">
                        <label for="">Logo Halaman Login & Daftar <span class="text-muted">(Optional)</span></label>
                        <input type="file" class="form-control" name="logo_login_setting" placeholder="" accept="image/*" />
                    </div>
                    <div class="col-md-6 mb-3">
                        <label for="">Preview Foto Login</label>
                        <br>
